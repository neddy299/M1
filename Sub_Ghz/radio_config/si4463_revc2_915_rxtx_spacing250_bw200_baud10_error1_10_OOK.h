...
/*
*
*  si4463_revc2_915_rxtx_spacing250_bw200_baud10_error1_10_OOK.h
*
*  M1 sub-ghz config for 915 RxTx mode
*
* M1 Project
*
*/

#ifndef M1_SUB_GHZ_915_RXTX_CONF_H_
#define M1_SUB_GHZ_915_RXTX_CONF_H_
...
#ifndef RADIO_915_CONFIG_H_
#define RADIO_915_CONFIG_H_
...
#define RADIO_915_CONFIGURATION_DATA_RADIO_XO_FREQ                     32000000L
#define RADIO_915_CONFIGURATION_DATA_CHANNEL_NUMBER                    0x00
#define RADIO_915_CONFIGURATION_DATA_RADIO_PACKET_LENGTH               0x19
#define RADIO_915_CONFIGURATION_DATA_RADIO_STATE_AFTER_POWER_UP        0x03
#define RADIO_915_CONFIGURATION_DATA_RADIO_DELAY_CNT_AFTER_RESET       0xF000
#define RADIO_915_CONFIGURATION_DATA_CUSTOM_PAYLOAD					   {0xC5, 0xC5, 0xC5, 0xC5, 0xC5, 0xC5, 0xC5, 0xC5, 0xC5, 0xC5, 0xC5, 0xC5, 0xC5, 0xC5, 0xC5, 0xC5, 0xC5, 0xC5, 0xC5, 0xC5, \
...
/*
// Command:                  RF_915_POWER_UP
// Description:              Command to power-up the device and select the operational mode and functionality.
*/
#define RF_915_POWER_UP 0x02, 0x81, 0x00, 0x01, 0xE8, 0x48, 0x00
...
*/
#define RF_915_GLOBAL_XO_TUNE_2 0x11, 0x00, 0x02, 0x00, 0x52, 0x00

/*
// Set properties:           RF_915_GLOBAL_CONFIG_1
...
*/
#define RF_915_GLOBAL_CONFIG_1 0x11, 0x00, 0x01, 0x03, 0x20

/*
// Set properties:           RF_915_INT_CTL_ENABLE_4
...
*/
#define RF_915_INT_CTL_ENABLE_4 0x11, 0x01, 0x04, 0x00, 0x07, 0x30, 0x01, 0x08

/*
// Set properties:           RF_915_FRR_CTL_A_MODE_4
// Number of properties:     4
// Group ID:                 0x02
// Start ID:                 0x00
...
*/
#define RF_915_FRR_CTL_A_MODE_4 0x11, 0x02, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00

/*
// Set properties:           RF_915_PREAMBLE_TX_LENGTH_9
...
*/
#define RF_915_PREAMBLE_TX_LENGTH_9 0x11, 0x10, 0x09, 0x00, 0x00, 0x14, 0x00, 0x0F, 0x31, 0x00, 0x00, 0x00, 0x00

/*
// Set properties:           RF_915_SYNC_CONFIG_6
...
*/
#define RF_915_SYNC_CONFIG_6 0x11, 0x11, 0x06, 0x00, 0x01, 0xAA, 0x2A, 0x00, 0x00, 0x00

/*
// Set properties:           RF_915_PKT_CRC_CONFIG_12
...
*/
#define RF_915_PKT_CRC_CONFIG_12 0x11, 0x12, 0x0C, 0x00, 0x00, 0x01, 0x08, 0xFF, 0xFF, 0x20, 0x02, 0x00, 0x00, 0x00, 0x00, 0x30

/*
// Set properties:           RF_915_PKT_RX_THRESHOLD_12
// Number of properties:     12
// Group ID:                 0x12
// Start ID:                 0x0C
...
*/
#define RF_915_PKT_RX_THRESHOLD_12 0x11, 0x12, 0x0C, 0x0C, 0x30, 0x00, 0x19, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00

/*
// Set properties:           RF_915_PKT_FIELD_3_CRC_CONFIG_12
// Number of properties:     12
// Group ID:                 0x12
// Start ID:                 0x18
...
*/
#define RF_915_PKT_FIELD_3_CRC_CONFIG_12 0x11, 0x12, 0x0C, 0x18, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00

/*
// Set properties:           RF_915_PKT_RX_FIELD_1_CRC_CONFIG_12
// Number of properties:     12
// Group ID:                 0x12
// Start ID:                 0x24
// Default values:           0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
...
*/
#define RF_915_PKT_RX_FIELD_1_CRC_CONFIG_12 0x11, 0x12, 0x0C, 0x24, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00

/*
// Set properties:           RF_915_PKT_RX_FIELD_4_CRC_CONFIG_5
...
*/
#define RF_915_PKT_RX_FIELD_4_CRC_CONFIG_5 0x11, 0x12, 0x05, 0x30, 0x00, 0x00, 0x00, 0x00, 0x00

/*
// Set properties:           RF_915_PKT_CRC_SEED_31_24_4
// Number of properties:     4
// Group ID:                 0x12
// Start ID:                 0x36
...
*/
#define RF_915_PKT_CRC_SEED_31_24_4 0x11, 0x12, 0x04, 0x36, 0x00, 0x00, 0x00, 0x00

/*
// Set properties:           RF_915_MODEM_MOD_TYPE_12
// Number of properties:     12
// Group ID:                 0x20
// Start ID:                 0x00
...
*/
#define RF_915_MODEM_MOD_TYPE_12 0x11, 0x20, 0x0C, 0x00, 0x01, 0x00, 0x07, 0x01, 0x86, 0xA0, 0x01, 0xE8, 0x48, 0x00, 0x00, 0x00

/*
// Set properties:           RF_915_MODEM_FREQ_DEV_0_1
// Number of properties:     1
// Group ID:                 0x20
// Start ID:                 0x0C
// Default values:           0xD3, 
...
*/
#define RF_915_MODEM_FREQ_DEV_0_1 0x11, 0x20, 0x01, 0x0C, 0x00

/*
// Set properties:           RF_915_MODEM_TX_RAMP_DELAY_12
// Number of properties:     12
// Group ID:                 0x20
// Start ID:                 0x18
...
*/
#define RF_915_MODEM_TX_RAMP_DELAY_12 0x11, 0x20, 0x0C, 0x18, 0x00, 0x80, 0x08, 0x03, 0xC0, 0x00, 0x16, 0x20, 0x00, 0xE8, 0x00, 0x64

/*
// Set properties:           RF_915_MODEM_BCR_NCO_OFFSET_2_12
// Number of properties:     12
// Group ID:                 0x20
// Start ID:                 0x24
...
*/
#define RF_915_MODEM_BCR_NCO_OFFSET_2_12 0x11, 0x20, 0x0C, 0x24, 0x05, 0x1E, 0xB8, 0x02, 0x8F, 0x00, 0xC2, 0x00, 0x54, 0x23, 0x00, 0x29

/*
// Set properties:           RF_915_MODEM_AFC_LIMITER_1_3
...
*/
#define RF_915_MODEM_AFC_LIMITER_1_3 0x11, 0x20, 0x03, 0x30, 0x0D, 0xD6, 0x80

/*
// Set properties:           RF_915_MODEM_AGC_CONTROL_1
// Number of properties:     1
// Group ID:                 0x20
// Start ID:                 0x35
// Default values:           0xE0, 
...
*/
#define RF_915_MODEM_AGC_CONTROL_1 0x11, 0x20, 0x01, 0x35, 0x60

/*
// Set properties:           RF_915_MODEM_AGC_WINDOW_SIZE_12
// Number of properties:     12
// Group ID:                 0x20
// Start ID:                 0x38
...
*/
#define RF_915_MODEM_AGC_WINDOW_SIZE_12 0x11, 0x20, 0x0C, 0x38, 0x11, 0x16, 0x16, 0x80, 0x02, 0xFF, 0xFF, 0x00, 0x28, 0x0C, 0x84, 0x21

/*
// Set properties:           RF_915_MODEM_RAW_CONTROL_10
...
*/
#define RF_915_MODEM_RAW_CONTROL_10 0x11, 0x20, 0x0A, 0x45, 0x8C, 0x06, 0x3D, 0x01, 0x00, 0xFF, 0x06, 0x00, 0x18, 0x40

/*
// Set properties:           RF_915_MODEM_RAW_SEARCH2_2
// Number of properties:     2
// Group ID:                 0x20
// Start ID:                 0x50
...
*/
#define RF_915_MODEM_RAW_SEARCH2_2 0x11, 0x20, 0x02, 0x50, 0x94, 0x08

/*
// Set properties:           RF_915_MODEM_SPIKE_DET_2
// Number of properties:     2
// Group ID:                 0x20
// Start ID:                 0x54
...
*/
#define RF_915_MODEM_SPIKE_DET_2 0x11, 0x20, 0x02, 0x54, 0x0A, 0x07

/*
// Set properties:           RF_915_MODEM_RSSI_MUTE_1
// Number of properties:     1
// Group ID:                 0x20
// Start ID:                 0x57
// Default values:           0x00, 
...
*/
#define RF_915_MODEM_RSSI_MUTE_1 0x11, 0x20, 0x01, 0x57, 0x00

/*
// Set properties:           RF_915_MODEM_DSA_CTRL1_5
// Number of properties:     5
// Group ID:                 0x20
// Start ID:                 0x5B
// Default values:           0x00, 0x00, 0x00, 0x00, 0x00, 
...
*/
#define RF_915_MODEM_DSA_CTRL1_5 0x11, 0x20, 0x05, 0x5B, 0x40, 0x04, 0x1E, 0x78, 0x20

/*
// Set properties:           RF_915_MODEM_CHFLT_RX1_CHFLT_COE13_7_0_12
// Number of properties:     12
// Group ID:                 0x21
// Start ID:                 0x00
...
*/
#define RF_915_MODEM_CHFLT_RX1_CHFLT_COE13_7_0_12 0x11, 0x21, 0x0C, 0x00, 0xFF, 0xC4, 0x30, 0x7F, 0xF5, 0xB5, 0xB8, 0xDE, 0x05, 0x17, 0x16, 0x0C

/*
// Set properties:           RF_915_MODEM_CHFLT_RX1_CHFLT_COE1_7_0_12
// Number of properties:     12
// Group ID:                 0x21
// Start ID:                 0x0C
...
*/
#define RF_915_MODEM_CHFLT_RX1_CHFLT_COE1_7_0_12 0x11, 0x21, 0x0C, 0x0C, 0x03, 0x00, 0x15, 0xFF, 0x00, 0x00, 0xFF, 0xC4, 0x30, 0x7F, 0xF5, 0xB5

/*
// Set properties:           RF_915_MODEM_CHFLT_RX2_CHFLT_COE7_7_0_12
// Number of properties:     12
// Group ID:                 0x21
// Start ID:                 0x18
...
*/
#define RF_915_MODEM_CHFLT_RX2_CHFLT_COE7_7_0_12 0x11, 0x21, 0x0C, 0x18, 0xB8, 0xDE, 0x05, 0x17, 0x16, 0x0C, 0x03, 0x00, 0x15, 0xFF, 0x00, 0x00

/*
// Set properties:           RF_915_PA_MODE_4
// Number of properties:     4
// Group ID:                 0x22
// Start ID:                 0x00
...
*/
#define RF_915_PA_MODE_4 0x11, 0x22, 0x04, 0x00, 0x08, 0x7F, 0x00, 0x5D

/*
// Set properties:           RF_915_SYNTH_PFDCP_CPFF_7
...
*/
#define RF_915_SYNTH_PFDCP_CPFF_7 0x11, 0x23, 0x07, 0x00, 0x2C, 0x0E, 0x0B, 0x04, 0x0C, 0x73, 0x03

/*
// Set properties:           RF_915_MATCH_VALUE_1_12
// Number of properties:     12
// Group ID:                 0x30
// Start ID:                 0x00
// Default values:           0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
...
*/
#define RF_915_MATCH_VALUE_1_12 0x11, 0x30, 0x0C, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00

/*
// Set properties:           RF_915_FREQ_CONTROL_INTE_8
...
*/
#define RF_915_FREQ_CONTROL_INTE_8 0x11, 0x40, 0x08, 0x00, 0x38, 0x09, 0x80, 0x00, 0x20, 0x00, 0x20, 0xFF
...
#define RADIO_915_CONFIGURATION_DATA_ARRAY { \
        SI446X_PATCH_CMDS, \
        0x07, RF_915_POWER_UP, \
        0x08, RF_915_GPIO_PIN_CFG, \
        0x06, RF_915_GLOBAL_XO_TUNE_2, \
        0x05, RF_915_GLOBAL_CONFIG_1, \
        0x08, RF_915_INT_CTL_ENABLE_4, \
        0x08, RF_915_FRR_CTL_A_MODE_4, \
        0x0D, RF_915_PREAMBLE_TX_LENGTH_9, \
        0x0A, RF_915_SYNC_CONFIG_6, \
        0x10, RF_915_PKT_CRC_CONFIG_12, \
        0x10, RF_915_PKT_RX_THRESHOLD_12, \
        0x10, RF_915_PKT_FIELD_3_CRC_CONFIG_12, \
        0x10, RF_915_PKT_RX_FIELD_1_CRC_CONFIG_12, \
        0x09, RF_915_PKT_RX_FIELD_4_CRC_CONFIG_5, \
        0x08, RF_915_PKT_CRC_SEED_31_24_4, \
        0x10, RF_915_MODEM_MOD_TYPE_12, \
        0x05, RF_915_MODEM_FREQ_DEV_0_1, \
        0x10, RF_915_MODEM_TX_RAMP_DELAY_12, \
        0x10, RF_915_MODEM_BCR_NCO_OFFSET_2_12, \
        0x07, RF_915_MODEM_AFC_LIMITER_1_3, \
        0x05, RF_915_MODEM_AGC_CONTROL_1, \
        0x10, RF_915_MODEM_AGC_WINDOW_SIZE_12, \
        0x0E, RF_915_MODEM_RAW_CONTROL_10, \
        0x06, RF_915_MODEM_RAW_SEARCH2_2, \
        0x06, RF_915_MODEM_SPIKE_DET_2, \
        0x05, RF_915_MODEM_RSSI_MUTE_1, \
        0x09, RF_915_MODEM_DSA_CTRL1_5, \
        0x10, RF_915_MODEM_CHFLT_RX1_CHFLT_COE13_7_0_12, \
        0x10, RF_915_MODEM_CHFLT_RX1_CHFLT_COE1_7_0_12, \
        0x10, RF_915_MODEM_CHFLT_RX2_CHFLT_COE7_7_0_12, \
        0x08, RF_915_PA_MODE_4, \
        0x0B, RF_915_SYNTH_PFDCP_CPFF_7, \
        0x10, RF_915_MATCH_VALUE_1_12, \
        0x0C, RF_915_FREQ_CONTROL_INTE_8, \
        0x00 \
 }
#else
#define RADIO_915_CONFIGURATION_DATA_ARRAY { 0 }
#endif

// DEFAULT VALUES FOR CONFIGURATION PARAMETERS
#define RADIO_915_CONFIGURATION_DATA_RADIO_XO_FREQ_DEFAULT                     30000000L
#define RADIO_915_CONFIGURATION_DATA_CHANNEL_NUMBER_DEFAULT                    0x00
#define RADIO_915_CONFIGURATION_DATA_RADIO_PACKET_LENGTH_DEFAULT               0x10
#define RADIO_915_CONFIGURATION_DATA_RADIO_STATE_AFTER_POWER_UP_DEFAULT        0x01
#define RADIO_915_CONFIGURATION_DATA_RADIO_DELAY_CNT_AFTER_RESET_DEFAULT       0x1000
#define RADIO_915_CONFIGURATION_DATA_CUSTOM_PAYLOAD_DEFAULT					   {0x42, 0x55, 0x54, 0x54, 0x4F, 0x4E, 0x31} // BUTTON1 

#define RADIO_915_CONFIGURATION_DATA_RADIO_PATCH_INCLUDED                      0x00
#define RADIO_915_CONFIGURATION_DATA_RADIO_PATCH_SIZE                          0x00
#define RADIO_915_CONFIGURATION_DATA_RADIO_PATCH                               {  }

#ifndef RADIO_915_CONFIGURATION_DATA_ARRAY
#error "This property must be defined!"
#endif

#ifndef RADIO_915_CONFIGURATION_DATA_RADIO_XO_FREQ
#define RADIO_915_CONFIGURATION_DATA_RADIO_XO_FREQ          RADIO_915_CONFIGURATION_DATA_RADIO_XO_FREQ_DEFAULT 
#endif

#ifndef RADIO_915_CONFIGURATION_DATA_CHANNEL_NUMBER
#define RADIO_915_CONFIGURATION_DATA_CHANNEL_NUMBER         RADIO_915_CONFIGURATION_DATA_CHANNEL_NUMBER_DEFAULT 
#endif

#ifndef RADIO_915_CONFIGURATION_DATA_RADIO_PACKET_LENGTH
#define RADIO_915_CONFIGURATION_DATA_RADIO_PACKET_LENGTH    RADIO_915_CONFIGURATION_DATA_RADIO_PACKET_LENGTH_DEFAULT 
#endif

#ifndef RADIO_915_CONFIGURATION_DATA_RADIO_STATE_AFTER_POWER_UP
#define RADIO_915_CONFIGURATION_DATA_RADIO_STATE_AFTER_POWER_UP   RADIO_915_CONFIGURATION_DATA_RADIO_STATE_AFTER_POWER_UP_DEFAULT 
#endif

#ifndef RADIO_915_CONFIGURATION_DATA_RADIO_DELAY_CNT_AFTER_RESET
#define RADIO_915_CONFIGURATION_DATA_RADIO_DELAY_CNT_AFTER_RESET  RADIO_915_CONFIGURATION_DATA_RADIO_DELAY_CNT_AFTER_RESET_DEFAULT 
#endif

#ifndef RADIO_915_CONFIGURATION_DATA_CUSTOM_PAYLOAD
#define RADIO_915_CONFIGURATION_DATA_CUSTOM_PAYLOAD         RADIO_915_CONFIGURATION_DATA_CUSTOM_PAYLOAD_DEFAULT 
#endif

#define RADIO_915_CONFIGURATION_DATA { \
                            Radio_915_Configuration_Data_Array,                            \
                            RADIO_915_CONFIGURATION_DATA_CHANNEL_NUMBER,                   \
                            RADIO_915_CONFIGURATION_DATA_RADIO_PACKET_LENGTH,              \
                            RADIO_915_CONFIGURATION_DATA_RADIO_STATE_AFTER_POWER_UP,       \
                            RADIO_915_CONFIGURATION_DATA_RADIO_DELAY_CNT_AFTER_RESET,       \
                            RADIO_915_CONFIGURATION_DATA_CUSTOM_PAYLOAD                   \
                            }

#endif /* RADIO_915_CONFIG_H_ */
