...
/*
*  m1_power_smart_decode.c
*
*  M1 sub-ghz Power Smart 16-bit decoding
*  Encoding: short-high + long-low → bit 0; long-high + short-low → bit 1
*  te_short ~225μs, te_long ~675μs (1:3 ratio)
*  Smart power strip remotes on 433.92 MHz
*/
...
#define M1_LOGDB_TAG	"SUBGHZ_POWERSMART"
