...
/*
*  m1_nice_flo_decode.c
*
*  M1 sub-ghz Nice FLO 12-bit decoding
*  Encoding: short-high + long-low → bit 0; long-high + short-low → bit 1
*  te_short ~700μs, te_long ~1400μs (1:2 ratio)
*/
...
#define M1_LOGDB_TAG	"SUBGHZ_NICE_FLO"
...
uint8_t subghz_decode_nice_flo(uint16_t p, uint16_t pulsecount)
{
    ...
    /* Nice FLO: same encoding as CAME but different timings */
