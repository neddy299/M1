...
/*
*  m1_marantec_decode.c
*
*  M1 sub-ghz Marantec 12-bit decoding
*  Encoding: short-high + long-low → bit 0; long-high + short-low → bit 1
*  te_short ~800μs, te_long ~1600μs (1:2 ratio)
*  Garage door openers on 433.92 MHz (common in EU)
*/
...
#define M1_LOGDB_TAG	"SUBGHZ_MARANTEC"
